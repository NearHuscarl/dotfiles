...
call s:Col('ColorColumn', 'red', s:linenr_background)
...
hi MatchParen gui=reverse guifg=#d26937 guibg=#0c1014
...
" Javascript
call s:Col('javaScriptFunction', 'orange')
