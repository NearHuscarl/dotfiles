...
let s:colors = {}
" cterm has been modified by Near to fix the cmd color in win
" Base colors.
let s:colors.base0 = { 'gui': '#0c1014', 'cterm': 0 }
let s:colors.base1 = { 'gui': '#11151c', 'cterm': 8 }
let s:colors.base2 = { 'gui': '#091f2e', 'cterm': 2  }
let s:colors.base3 = { 'gui': '#0a3749', 'cterm': 6  }
let s:colors.base4 = { 'gui': '#245361', 'cterm': 1  }
let s:colors.base5 = { 'gui': '#599cab', 'cterm': 3  }
let s:colors.base6 = { 'gui': '#99d1ce', 'cterm': 7  }
let s:colors.base7 = { 'gui': '#d3ebe9', 'cterm': 15 }
" Other colors.
let s:colors.red     = { 'gui': '#c23127', 'cterm': 12 }
let s:colors.orange  = { 'gui': '#d26937', 'cterm': 4  }
let s:colors.yellow  = { 'gui': '#edb443', 'cterm': 14 }
let s:colors.magenta = { 'gui': '#888ca6', 'cterm': 13 }
let s:colors.violet  = { 'gui': '#4e5166', 'cterm': 5  }
let s:colors.blue    = { 'gui': '#195466', 'cterm': 9  }
let s:colors.cyan    = { 'gui': '#33859E', 'cterm': 11 }
let s:colors.green   = { 'gui': '#2aa889', 'cterm': 10 }
...
call s:Col('Normal', 'base5', s:background)
...
call s:Col('MatchParen', 'red', 'base5')
...
call s:Col('EasyMotionShade', 'base3') 
call s:Col('EasyMotionTarget', 'red') 
call s:Col('EasyMotionMoveHL', 'green') 
call s:Col('EasyMotionIncSearch', 'green') 
"hi EasyMotionShade  ctermbg=none ctermfg=base3
hi EasyMotionTarget2First ctermbg=none ctermfg=red cterm=bold
hi EasyMotionTarget2Second ctermbg=none ctermfg=yellow cterm=bold
