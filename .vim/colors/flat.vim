...
if ($TERM =~ '256' || &t_Co >= 256) || has('gui_running')
  ...
  hi Cursor        ctermbg=NONE ctermfg=NONE guibg=NONE    guifg=NONE    cterm=reverse   gui=reverse
  ...
  hi Function      ctermbg=NONE ctermfg=12   guibg=NONE    guifg=#3498db cterm=NONE      gui=NONE
  ...
  if has('gui_running')
    hi SpellBad   gui=undercurl guisp=#c0392b
    hi SpellCap   gui=undercurl guisp=#2aa198
    hi SpellLocal gui=undercurl guisp=#27ae60
    hi SpellRare  gui=undercurl guisp=#e74c3c
  else
    hi SpellBad   ctermbg=NONE ctermfg=1  cterm=underline
    hi SpellCap   ctermbg=NONE ctermfg=14 cterm=underline
    hi SpellLocal ctermbg=NONE ctermfg=2  cterm=underline
    hi SpellRare  ctermbg=NONE ctermfg=9  cterm=underline
  endif
