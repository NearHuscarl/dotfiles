...
nnoremap <silent><buffer> t1 :call todo#JumpToReminder()<CR>zz
nnoremap <silent><buffer> t2 :call todo#JumpToTodo()<CR>zz
nnoremap <silent><buffer> t3 :call todo#JumpToArchive()<CR>zz
